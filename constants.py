...
PADDLE_OFFSET = 30
#: distance paddle moves for each key input
PADDLE_ANIMATION_STEP=10
#: multiple of increase in ball's x velocity each time ball hits the paddle
XVELOCITY_UP_CONSTANT=1.115
...
BALL_DIAMETER = 18
#: ball velocity in the y direction
BALL_YVELOCITY = -5.0
#: original ball velocity in the x direction
BALL_XVELOCITY = 1.2
...
STATE_ACTIVE    = 4
#: state when the game is finished
STATE_COMPLETE  = 5
#: state when the player beat any level below 4
STATE_NEWLEVEL = 6

#: how much score goes down when the ball is lost first time
SCORE_PENALTY_1 = 50
#: how much score goes down when the ball is lost second time
SCORE_PENALTY_2 = 1000
#: how much score goes down when the ball is lost third time
SCORE_PENALTY_3= 5000
